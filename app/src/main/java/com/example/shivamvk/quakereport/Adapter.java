...
public class Adapter extends ArrayAdapter {
    ...
    public Adapter(Activity context, ArrayList<ListItem> words){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String formattedMagnitude = formatMagnitude(currentItem.getmMagnitude());
        magnitude.setText(formattedMagnitude);

        primaryLocationView.setText(primaryLocation);
        locationOffsetView.setText(locationOffset);

        Date dateObject = new Date(currentItem.getmDate());
